...
Open your host project's `Podfile`, add the SDK dependency, and **ensure you configure** the global dynamic linkage and module stability hooks:
...
target 'YourAppTargetName' do
  pod 'EWOCPPSDK'
  # Replace the tag with the latest released version of the SDK
  pod 'EWOCPPSDK', :git => '[https://github.com/kelijun/EWOCPPSDK.git](https://github.com/kelijun/EWOCPPSDK.git)', :tag => '1.0.0'
end

# 🌟 REQUIRED: Enable module stability for all underlying dependencies to prevent 'Signal 6 / Symbol not found' crashes across different Xcode versions.
